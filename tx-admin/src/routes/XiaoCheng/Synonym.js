...
export default class Synonym extends PureComponent {
    ...
    render() {
        const { dataList, total } = this.props.synonym && this.props.synonym.data || [];
