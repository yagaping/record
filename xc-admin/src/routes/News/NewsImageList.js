...
@Form.create()
export default class NewsImageList extends PureComponent {
  state = {
    modalTitle: '标题',
  ...
  queryContentList() {
    ...
    dispatch({
      type: 'newsContentList/queryByNewsImageList',
      payload: {
  ...
  handleModalModify = (newValues, oldValue) => {
    // 修改需要注意：后台有 两属性不一致.
    this.props.dispatch({
      type: 'newsContentList/modifyNewsImage',
      payload: {
        body: {
          ...newValues,
          newsImageId: oldValue.newsImageId,
