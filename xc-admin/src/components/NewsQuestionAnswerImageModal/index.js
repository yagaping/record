...
class NewsQuestionAnswerImageModalForm extends PureComponent {
  static propTypes = {
...
const NewsQuestionAnswerImageModal = Form.create({
...
})(NewsQuestionAnswerImageModalForm);
export default NewsQuestionAnswerImageModal;
