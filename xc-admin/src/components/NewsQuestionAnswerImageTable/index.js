...
class NewsQuestionAnswerImageTable extends PureComponent {
  state = {
    selectedRowKeys: [],
    totalCallNo: 0,
  };
  ...
  render() {
    ...
    return (
      <div className={styles.standardTable}>
        <Table
          loading={loading}
          rowKey={newsQuestionAnswerImage => newsQuestionAnswerImage.newsQuestionAnswerImageId}
...
NewsQuestionAnswerImageTable.STATUS_MAP = STATUS_MAP;
export default NewsQuestionAnswerImageTable;
