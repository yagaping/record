...
class NewsContentVideoModalForm extends PureComponent {
  static propTypes = {
...
const NewsContentVideoModal = Form.create({
  mapPropsToFields(props) {
    ...
    const { videoImage, authAccess } = props.newsData;
    return {
...
})(NewsContentVideoModalForm);
export default NewsContentVideoModal;
